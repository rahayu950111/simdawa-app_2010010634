            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= base_url('jenis/cetak') ?>" class="btn btn-sm btn-info mr-1 float-right"><i class="fas fa-print">Cetak Data</i></a>
                    </div>
                    <div class="card-body">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('jenis/hapus/' . $a->id) ?>" class="btn btn-sm btn-danger" onclick='return confirm("Ingin hapus data ini?")'><i class="fas fa-trash"> Hapus</i></a>
                                        </td>
                                    </tr>
                                <?php
                                }
